...
<script type="text/javascript" src="<?=$dir;?>easyui/plugins/datagrid-dnd.js"></script>
...
<div id="tt" class="easyui-tabs" style="height:auto;">
    <div title="Список" style="padding:10px" data-options="closable:false" >
        <table class="easyui-datagrid" id="dataGrid" title="Общая таблица"
            data-options="
				idField:'<?=$idField;?>',
				toolbar:'#tbar',
				singleSelect:true,
				...
				onLoadSuccess:function(){
					<?=$jqname;?>(this).datagrid('enableDnd');
				},
...
<!--        <a href="#" class="easyui-linkbutton"  iconCls="icon-remove" plain="true" onclick="javascript:<?=$jqname;?>('#dataGrid').edatagrid('destroyRow')"> Удалить</a> 
        <a href="#" class="easyui-linkbutton"  iconCls="icon-remove" plain="true" onclick="delBtn()"> Удалить</a>-->
...
<script type="text/javascript">
    ...
    function addPanel(id){
        ...
        <?=$jqname;?>('#tt').tabs('add',{
            title: title,
            content: '<iframe scrolling="yes" frameborder="0"  src="'+ url +'" style="width:100%;height:750px"></iframe>',
            height: '500px',
            closable: true
        });
    }
